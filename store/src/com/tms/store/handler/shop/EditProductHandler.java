...
public class EditProductHandler extends MenuSelectionExceptionHandler {
    private final Shop shop;
    private final ProductReader reader;

    public EditProductHandler(Shop shop, ProductReader reader, ReportWriter writer) {
        super(writer);
        this.shop = shop;
        this.reader = reader;
    }
